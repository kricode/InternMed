...
import 'package:intern/screens/Service_Not_Available.dart';
...
class _Services_ScreenState extends State<Services_Screen> {
  ...
  Future<dynamic> getDoctorInfo(String? email) async {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> _savePrefs(dynamic data) async {
      final SharedPreferences _prefs = await prefs;
      _prefs.setString('nom', data["nom"]);
      _prefs.setString('prenom', data["prenom"]);
      _prefs.setString('email', data["email"]);
      _prefs.setString('datenaissance', data["datenaissance"].toString());
      setState(() {
        preferences = _prefs;
      });
    }
                          ...
                          Tooltip(
                            ...
                            child: GestureDetector(
                              ...
                              child: Image(
                                  width: width * 0.08,
                                  image:
                                      AssetImage('assets/icons/log-out.png')),
                            ),
                          ),
                        ],
                      ),
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  ...
                                  Future.delayed(Duration(milliseconds: 500),
                                    ...
                                    switch (serviceList[index].name) {
                                      case 'Gynecologie':
                                        return Get.to(List_Patients(
                                          service: serviceList[index],
                                          doctor: medecin,
                                        ));
                                      default:
                                        Get.to(Service_Not_Available());
                                    }
                                  });
                                },
                                      ...
                                      children: [
                                        GestureDetector(
                                          ...
                                          child: Hero(
                                            ...
                                            child: Image(
                                              image: AssetImage(tappedservice !=
                                                      serviceList[index]
                                                  ? serviceList[index]
                                                      .blueimagePath
                                                  : serviceList[index]
